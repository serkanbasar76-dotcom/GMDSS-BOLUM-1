...
RAW_DATA = [
    ...
    {"q": "Inmarsat-C terminalinde mesajın ulaştığını gösteren onay mesajına ne ad verilir?", "a": "ACK (Acknowledgement)", "options": ["Delivery Notification", "ACK (Acknowledgement)", "Echo", "Receipt", "Done"]},
